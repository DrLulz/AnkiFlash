...
PDF_DIR = '/Users/drlulz/Downloads/AnkiFlash-master/Medstudy Internal Medicine Flash Cards (2014-2015).pdf'
...
def make_cards(card_front, card_back, SUBSECTION):
    ...
    mname = 'AnkiFlash-MedStudy'
    dname = 'Flashcards' + '::' + 'Medstudy Internal Medicine::{}'.format(SUBSECTION)
    ...
    card.tags       = [(re.sub(r'(\d+.\s+)', '', SUBSECTION)).replace(' ', '-')]
...
def main():
    ...
    TOC = [(6, 25, '01. Allergy & Immunology'), (27, 80, '02. Cardiology'), (82, 145, '03. Dermatology'), (147, 248, '04. Endocrinology'), (250, 335, '05. Gastroenterology'), (337, 432, '06. General Internal Medicine'), (434, 531, '07. Hematology'), (533, 724, '08. Infectious Diseases'), (726, 783, '09. Nephrology'), (785, 872, '10. Neurology'), (874, 893, '11. Oncology'), (895, 976, '12. Pulmonary Medicine'), (978, 1071, '13. Rheumatology')]
