...
PDF_DIR = '/Users/drlulz/Downloads/AnkiFlash-master/Pathophysiology of Disease Flashcards.pdf'
...
def make_cards(card_front, card_back, SUBSECTION):
    ...
    mname = 'AnkiFlash'
    dname = 'Flashcards' + '::' + 'Pathophysiology of Disease::{}'.format(SUBSECTION)
